...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91 6280156474</li>	
					<li class="s-bar">
						<div class="search">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">Write Whatever You Want</p>
...
<section class="portfolio-w3ls" id="gallery">
		 <h3 class="title-w3-agileits title-black-wthree">Our Gallery</h3>
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/first.jpg" class="swipebox"><img src="images/first.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>PARA DISE</h4>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/second.jpg" class="swipebox"><img src="images/second.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>PARA DISE</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
				...
				<div class="col-md-3 gallery-grid gallery1">
					<a href="images/g6.jpg" class="swipebox"><img src="images/seven.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>PARA DISE</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
					   </div>
				...
				<div class="col-md-3 gallery-grid gallery1">
					...
					<div class="col-md-3 gallery-grid gallery1">
					<a href="images/nine.jpg" class="swipebox"><img src="images/nine.jpg" class="img-responsive" alt="/">
						<div class="textbox">
						<h4>PARA DISE</h4>
							<p><i class="fa fa-picture-o" aria-hidden="true"></i></p>
						</div>
					...
					<ul class="slides">
						<li>
							<div class="w3layouts_work_grid_left">
								...
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/sanchit.jpeg" alt=" " class="img-responsive" />
								</div>
							</div>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/nakul.jpeg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
						...
						<li>
							...
							<div class="w3layouts_work_grid_left">
								...
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/billa.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91 6280156474</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@PARADISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> Malhar Road, Ludhiana, Punjab</p>
